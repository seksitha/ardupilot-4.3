...
public:
    ...
    */
    ...
    virtual bool set_target_posvel_NED(const Vector3f& target_pos, const Vector3f& target_vel,bool used_rngfnd = false) { return false; }
    virtual float get_nav_pos_z_cm(){return 0.0f;};
